...
public class square2 extends AppCompatActivity {
    ...
    String documentName = MainMenu.returnDocumentName(2);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId() == R.id.item9) Toast.makeText(square2.this, "Clicked9", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    ...
    public void cartAddCheck(Integer counter, Integer ID, String spinner) {
        ...
        if (counter > 0) {
            if (spinner.equals("Choose a size")) {
                ...
                ID--;
                cartActivity.addToDatabase(square2.nameList[ID] + " " + documentName, counter, spinner);
