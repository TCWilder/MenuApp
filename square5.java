...
public class square5 extends AppCompatActivity {
    ...
    String documentName = MainMenu.returnDocumentName(5);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_square5);
        ...
        nav.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId() == R.id.item9) Toast.makeText(square5.this, "Clicked9", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    ...
    public void cartAddCheck(Integer counter, Integer ID, String spinner) {
        ...
        if (counter > 0) {
            if (spinner.equals("Choose a size")) {
                ...
                ID--;
                cartActivity.addToDatabase(square5.nameList[ID] + " " + documentName, counter, spinner);
