...
public class square4 extends AppCompatActivity {
    ...
    String documentName = MainMenu.returnDocumentName(4);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_square4);
        Log.d("myTag", "you + " + documentName);
        ...
        nav.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId() == R.id.item9) Toast.makeText(square4.this, "Clicked9", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    ...
    public void cartAddCheck(Integer counter, Integer ID, String spinner) {
        ...
        if (counter > 0) {
            if (spinner.equals("Choose a size")) {
                ...
                ID--;
                cartActivity.addToDatabase(square4.nameList[ID] + " " + documentName, counter, spinner);
