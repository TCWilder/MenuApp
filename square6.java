...
public class square6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_square6);
        ...
        nav.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId() == R.id.item9) Toast.makeText(square6.this, "Clicked9", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
        ...
        pageHeader.setText("Drinks");

        textView1 = (TextView) findViewById(R.id.textView1);
        textView2 = (TextView) findViewById(R.id.textView2);
        textView3 = (TextView) findViewById(R.id.textView3);
        textView4 = (TextView) findViewById(R.id.textView4);
        db.collection("PizzaPlanet").document("Inventory").collection("Drinks")
                .get()
        ...
        cartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cartAddCheck(counterInt1, 1, "regular");
                cartAddCheck(counterInt2, 2, "regular");
                cartAddCheck(counterInt3, 3, "regular");
                cartAddCheck(counterInt4, 4, "regular");
            }
        });
    }
    ...
    public void cartAddCheck(Integer counter, Integer ID, String spinner) {
        ...
        if (counter > 0) {
            if (spinner.equals("Choose a size")) {
                ...
                ID--;
                cartActivity.addToDatabase(square6.nameList[ID], counter, spinner);
